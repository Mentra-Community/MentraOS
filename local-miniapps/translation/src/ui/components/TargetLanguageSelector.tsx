    ...
    <div className="flex flex-col h-full bg-zinc-100">
      <div className="px-6 py-4 flex flex-col gap-4 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-zinc-500">Any source language</span>
        </div>
              ...
              <button
                ...
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="flex flex-col items-start min-w-0">
                    <span className="text-base font-bold text-gray-900 font-['Red_Hat_Display'] truncate">
                      {lang.name}
                    </span>
                    {lang.nativeName && (
                      <span className="text-sm text-gray-500 font-['Red_Hat_Display'] truncate">
                        {lang.nativeName}
                      </span>
                    )}
                  </div>
