...
public class WhipCameraCapturer implements VideoCapturer {
    ...
    private void startRepeatingRequest(Surface surface) {
        try {
            ...
            // Fixed FPS range
            builder.set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE, new Range<>(mFps, mFps));
            ...
            mSurfaceTextureHelper.startListening(
                    frame -> {
                        ...
                        TextureBufferImpl modifiedBuffer =
                        ...
                        VideoFrame modifiedFrame =
                                new VideoFrame(outputBuffer, frameRotation, frame.getTimestampNs());
