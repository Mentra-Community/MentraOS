...
public class OtaSessionManager {
     ...
     * Spec: https://github.com/Mentra-Community/Mentra-Specs/blob/main/platform/ota/ota-rearchitecture/spec.md §A / EC-5 — ~10s from process start so the old process can exit.
