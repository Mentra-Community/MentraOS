...
public class AsgSettings {
    ...
    /** Legacy coupled button key; migrated once into button ZSL/MFNR keys. */
    ...
    /** Clears scan/button-photo tuning prefs and restores global ZSL and MFNR defaults. */
    public void clearButtonPhotoCaptureTuning() {
        ...
        prefs.edit()
                ...
                .remove(KEY_ZSL_MFNR_ENABLED)
                .putBoolean(KEY_ZSL_ENABLED, AsgConstants.DEFAULT_ZSL)
                .putBoolean(KEY_MFNR_ENABLED, AsgConstants.DEFAULT_MFNR)
                .commit();
    }
