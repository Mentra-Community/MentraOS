...
public final class BesFirmwareArtifactValidator {
     ...
     */
    public static void validate(File artifact, JSONObject metadata) throws ValidationException {
        try {
            ...
            assertSha256(container, requiredSha256(metadata, "sha256"), "compressed");
            ...
            assertSha256(raw, requiredSha256(metadata, "decompressed_sha256"), "decompressed");
            assertProduct(raw, product);
            assertVersion(
                    raw, requiredString(metadata, "version"), metadata.getLong("version_offset"));
