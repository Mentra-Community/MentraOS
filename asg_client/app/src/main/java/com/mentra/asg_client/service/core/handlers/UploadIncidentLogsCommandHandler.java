 ...
 *
 * <p>Runs mh_logs to completion, then relays glasses_firmware and glasses JSON to the
 * phone via two sequential K900 BLE file transfers. The phone/host owns any backend upload.</p>
 */
    ...
    private void relayLogsViaBle(String incidentId) {
        ...
        try {
            ...
            if (mK900CommandHandler != null) {
                mK900CommandHandler.requestBesLogs(incidentId, json -> {
