...
/**
 * Debug-only helper that pulls the BES trace ring buffer at a short interval and emits only newly
 * observed lines into the MentraBleTrace log stream.
 */
public class BesTracePoller {
    ...
    private void pollOnce() {
        ...
        boolean started =
                mK900CommandHandler.requestBesLogsForTrace(
                        mContext, mConfigurationManager, this::onSnapshotReceived);
