...
public final class ServiceConstants {
    ...
    // OTA Update Actions
    // ---------------------------------------------
    public static final String ACTION_DOWNLOAD_PROGRESS = "com.mentra.recovery.ACTION_DOWNLOAD_PROGRESS";
    public static final String ACTION_INSTALLATION_PROGRESS = "com.mentra.recovery.ACTION_INSTALLATION_PROGRESS";
