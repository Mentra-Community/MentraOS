...
public class ImuRecorder implements SensorEventListener {
     ...
     *
     * <ul>
     *   <li>version: format version
     *   <li>sampleCount: number of samples
     *   <li>samplingRateHz: nominal sample rate
     *   <li>startTimeNs: capture start monotonic time
     *   <li>durationMs: total capture duration
     *   <li>samples: compact tuples [relativeTimeMs, ax, ay, az, gx, gy, gz]
     * </ul>
     *
