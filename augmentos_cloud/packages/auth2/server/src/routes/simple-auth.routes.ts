...
import { tokenService } from '../services/temp-token.service';
...
router.post('/internal/exchange-token', async (req: Request, res: Response) => {
...
router.post('/webview/generate-token', validateCoreToken, async (req: Request, res: Response) => {
...
router.post('/webview/exchange-user-token', validateTpaApiKey, async (req: Request, res: Response) => {
