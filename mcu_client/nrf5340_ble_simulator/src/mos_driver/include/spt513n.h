 ...
 * @note Must call spt513n_connect() within 100ms after reset to enter test mode
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Read a register from SPT513N
...
/**
 * @brief Write a register to SPT513N
 * @param addr Register address
