#ifndef WELCOME_VIEW_H_
#define WELCOME_VIEW_H_

#include <stdbool.h>
#include <stdint.h>
#include <lvgl.h>
#include "components/welcome_text.h"
#include "components/dfu_status.h"
#include "components/dfu_progress_bar.h"
