...
- Microphone error handling improved: -EALREADY errors now treated as warnings instead of failures to prevent unnecessary error states.
 ...
 - Disabled `uart0` in [mcu_client/nrf5340_ble_simulator/npm1300_config.overlay](mcu_client/nrf5340_ble_simulator/npm1300_config.overlay) to free P0.20/P0.21 for the EVT1 PDM microphone pins.
