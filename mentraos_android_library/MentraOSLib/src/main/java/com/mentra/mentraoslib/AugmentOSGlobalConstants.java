...
public class AugmentOSGlobalConstants {
    ...
    public static final String AugmentOSManagerPackageName = "com.mentra.mentra";
    public static final String AugmentOSAsgClientPackageName = "com.augmentos.asg_client";
    public static final String AugmentOSPkgName = "com.mentra.mentraoslib";
    public static final String FROM_TPA_FILTER = "com.mentra.fromtpa";
    public static final String TO_TPA_FILTER = "com.mentra.totpa";
    public static final String DEBUG_COMMAND_ID = "d7e9c6e2-8f50-4c56-8feb-6c826e789d86";
    public static final String DEBUG_WITH_ARGS_COMMAND_ID = "79355eaa-1aa0-49d7-a047-fdf25481ace6";
    public static final String DEBUG_WITH_NATURAL_LANGUAGE_COMMAND_ID = "9efbb1c6-7dfd-4ba2-9754-ec9bd7ffbbeb";
}
