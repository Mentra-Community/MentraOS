...
- Confirm `maven("https://www.jitpack.io")` is configured; some SDK dependencies are hosted there.
...
Check that your iOS deployment target is at least `15.1` and that the `MentraBluetoothSDK` pod version exists.
