...
- Confirm JitPack is reachable if Gradle cannot resolve runtime dependencies such as the Vuzix Ultralite SDK; these are transitive runtime dependencies and are not exposed by the SDK's public Android API.
