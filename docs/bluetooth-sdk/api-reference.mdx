...
| `settings_ack` | `SettingsAckEvent` | Gallery/button/FOV setting command applied, ready, or failed. Also returned by settings methods such as `setCameraFov(...)`. |
