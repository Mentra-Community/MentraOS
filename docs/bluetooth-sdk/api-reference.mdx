...
| `photo_status` | `PhotoStatusEvent` | Photo capture progress changes. May include `resolvedConfig` with effective size, compression, transfer method, exposure, and ISO. |
