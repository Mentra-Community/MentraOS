...
The SDK is published to Maven Central. Keep `maven("https://www.jitpack.io")` because some SDK dependencies are resolved from JitPack. The SDK POM pulls in the companion `com.mentraglass:lc3Lib` codec artifact automatically; do not add it manually unless you have a specific override reason.
