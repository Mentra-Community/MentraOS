---
title: Mentra App Guidelines
description: Coding standards and best practices for contributing to the Mentra App, the React Native phone app of the MentraOS ecosystem.
---

# Mentra App Development Guidelines

This guide provides coding standards and best practices for contributing to the Mentra App, the React Native phone app of the MentraOS ecosystem.

## Architecture Overview

The Mentra App is a React Native app built with:
...
- [Contributing Overview](/os-devs/contributing/overview)
