...
<Info>
For camera, photo, and streaming features, use the standalone [Bluetooth SDK docs](https://bluetooth-sdk-docs.mentra.glass) instead of the cloud Mini App permission model.
</Info>
