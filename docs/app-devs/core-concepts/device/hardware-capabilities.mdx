...
<Info>
Camera hardware details are useful for understanding device capability, but camera capture and streaming workflows are documented in the [Bluetooth SDK docs](https://bluetooth-sdk-docs.mentra.glass/camera-streaming).
</Info>
