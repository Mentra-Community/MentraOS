...
description: "How MentraOS miniapps serve both the API and webview from a single Bun process."
---

# Bun Fullstack Dev Server

A MentraOS miniapp is a single Bun process that does three things at once:
...
This is based on how the stream-test app works. Every MentraOS miniapp follows the same pattern:
