...
description: Build React-based webviews for MentraOS using @mentra/react. Learn setup, authentication, making authenticated API calls, CORS configuration, and troubleshooting with a full example.
