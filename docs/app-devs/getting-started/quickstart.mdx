...
<Info>
Building a mobile app that connects directly to glasses over Bluetooth? Use the [Bluetooth SDK Quickstart](https://bluetooth-sdk-docs.mentra.glass/quickstart).
</Info>
...
1. Start from the **Display Example App**. It displays spoken words as live captions on the glasses HUD and is the recommended cloud Mini App template for developers new to MentraOS.
   ...
   **Repository:** [MentraOS-Display-Example-App](https://github.com/Mentra-Community/MentraOS-Display-Example-App)
   ...
   <Info>
   For camera, photo, or streaming apps, use the [Bluetooth SDK Quickstart](https://bluetooth-sdk-docs.mentra.glass/quickstart) instead.
   </Info>
...
For camera, photo, or streaming features, use the [Bluetooth SDK docs](https://bluetooth-sdk-docs.mentra.glass).
