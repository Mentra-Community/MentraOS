...
1. Pick the example app template that matches your smart glasses:
   ...
   <Tabs>
     <Tab title="Camera Glasses">
       **Compatible glasses:** Mentra Live
     ...
     <Tab title="Display Glasses">
       **Compatible glasses:** Even Realities G1, Mentra Mach1, Vuzix Z100
...
| `session.camera` | Take photos and stream video |
