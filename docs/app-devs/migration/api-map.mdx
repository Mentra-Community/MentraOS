...
Camera, photo, and streaming workflows are no longer documented as the forward path for cloud Mini Apps. Use the standalone [Bluetooth SDK docs](https://bluetooth-sdk-docs.mentra.glass/camera-streaming) for camera-equipped glasses, direct mobile control, photo upload, and RTMP/SRT/WHIP streaming.
