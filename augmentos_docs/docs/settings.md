...
Settings are defined in the developer console. Go to [console.augmentos.org/apps](https://console.augmentos.org/apps) and edit your app, then look for the "App Settings" section.
