...
The `EventManager` handles event subscriptions and dispatching within a [`AppSession`](/reference/app-session). It provides methods for subscribing to various event types from the AugmentOS platform.
