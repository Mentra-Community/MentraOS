const en = {
  ...
  settings: {
    ...
    notificationsSubtitle: "Allow MentraOS to forward your phone notifications to your smart glasses.",
  ...
  profileSettings: {
    ...
    deleteAccountWarning1Message: "You are about to permanently delete your MentraOS account. This action is IRREVERSIBLE.",
  ...
  login: {
    ...
    login: "Login",
    connectingToMentraOS: "Connecting to MentraOS...",
