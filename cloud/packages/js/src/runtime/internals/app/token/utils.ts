 ...
 * ```
 */
export function createToken(payload: Omit<AppTokenPayload, "iat" | "exp">, config: TokenConfig): string {
 ...
 * ```
 */
export function validateToken(token: string, secretKey: string): TokenValidationResult {
  try {
