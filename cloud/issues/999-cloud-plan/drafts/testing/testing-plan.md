...
Each cloud client has its own test reference documenting every operation, transport, hop sequence, and failure mode:

- [Mobile Client (phone app)](./clients/mobile-client.md) - WebSocket + REST + UDP
- [SDK MiniApp (server-side)](./clients/sdk-miniapp.md) - WebSocket + REST
- [Developer Console](./clients/developer-console.md) - REST
- [CLI](./clients/cli.md) - REST
- [App Store](./clients/app-store.md) - REST
- [System Apps, Admin, and Infrastructure](./clients/system-and-infra.md) - REST
