...
type SubscriptionRequest = ExtendedStreamType | {stream: StreamType.LOCATION_STREAM; rate?: "fast" | "slow" | "off"}
...
export interface IAppManager {
  ...
  publish(topic: ExtendedStreamType, payload: unknown, options?: {exclude?: string[]}): number
