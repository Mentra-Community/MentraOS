...
describe("LiveKitGrpcClient", () => {
  ...
  beforeEach(() => {
    client = new LiveKitBridgeClient("localhost:9090", grpc.credentials.createInsecure())
  })
...
class GrpcClientPool {
  ...
  static getClient(): LiveKitBridgeClient {
    if (!this.instance) {
      this.instance = new LiveKitBridgeClient("localhost:9090", grpc.credentials.createInsecure())
    }
