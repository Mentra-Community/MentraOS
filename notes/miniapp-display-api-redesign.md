...
| G2-hack case study | [Maps display manager](https://github.com/Mentra-Community/maps-miniapp/blob/main/src/background/managers/DisplayManager.ts) |
