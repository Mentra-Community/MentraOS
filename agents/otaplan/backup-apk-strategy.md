...
public void recoverOtaUpdater() {
    ...
    try {
        ...
        if (info != null && info.packageName.equals("com.mentra.otaupdater")) {
            // Install backup
...
adb shell cp /data/app/com.mentra.otaupdater*/base.apk /storage/emulated/0/asg/ota_updater_backup.apk
