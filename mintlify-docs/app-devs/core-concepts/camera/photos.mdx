...
ASG client reports it was applied. It applies to all captures (photos and video),
and takes a single request object: either a named preset, or an explicit FOV plus
optional region.
