...
| Module | What it does |
|---|---|
| [`session.display`](/app-devs/core-concepts/display/layouts) | Text walls, reference cards, and bitmaps on the glasses HUD. |
| [`session.canvas`](/app-devs/core-concepts/canvas) | Lower-level positioned text and bitmap drawing. |
...
| Module | What it does |
|---|---|
| [`session.camera`](/app-devs/core-concepts/camera/README) | Photos and video on camera glasses. |
