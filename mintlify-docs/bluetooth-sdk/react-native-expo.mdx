...
<Warning>
SDK `0.1.21-beta.5` requires the matching Mentra Live `0.1.21-beta.5` glasses software. [Update Mentra Live before testing SDK features](/bluetooth-sdk/software-update).
</Warning>
