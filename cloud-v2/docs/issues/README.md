...
| **[004-mobile-client](./004-mobile-client/)** | | the transport we own |
| [runtime-transport](./004-mobile-client/runtime-transport/) | Stub | needs design; depends on 002 protocol + the subscription decision |
...
- **Audio subscription transport** (WS vs REST vs REST + pub/sub).
  ...
  Blocks finalizing 002 audio and designing 004 runtime-transport.
...
3. Spec `004-mobile-client/runtime-transport` (the client end of the protocol).
