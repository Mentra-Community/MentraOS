...
A thin internal service wrapping the swappable blob storage providers (Cloudflare R2, Alibaba OSS per region), exposing put/get/delete and signed-URL operations. Other services use it instead of talking to providers directly. For example, bundle storage is a concern of miniapp-service, which stores mini-app bundles through this service.
