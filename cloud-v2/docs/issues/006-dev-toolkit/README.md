...
Umbrella issue for the developer-facing toolkit: the SDK and CLI mini-app
developers build against.

## Pieces (subfolders)

- [`local-sdk/`](./local-sdk/): the Mentra Local SDK (`@mentra/miniapp`), the API
  developers write mini apps against. Apps built with it run in the Mentra Runtime
