...
DeveloperOrgInvitationSchema.index({orgId: 1, email: 1}, {unique: true, partialFilterExpression: {status: "pending"}})

export type DeveloperOrgInvitation = InferSchemaType<typeof DeveloperOrgInvitationSchema>
export const DeveloperOrgInvitationModel = registerModel("DeveloperOrgInvitation", DeveloperOrgInvitationSchema)
