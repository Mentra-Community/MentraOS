...
const ROWS: Row[] = [
  ...
  {emoji: "📦", title: "session.storage", subtitle: "get / set / delete / list", path: "/tester/storage"},
  {
    ...
    subtitle: "has / getAll / onUpdate / errors",
    path: "/tester/permissions",
  },
  {
    emoji: "⏳",
    title: "Coming Soon",
    ...
    <Shell>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        <p className="mb-3 px-1 text-[13px] text-muted-foreground">
          Each section exercises one module of the @mentra/miniapp SDK. Use this to verify your glasses + phone +
          miniapp host are talking correctly.
        </p>
