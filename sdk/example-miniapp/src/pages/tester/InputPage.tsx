  ...
  return (
    <Shell>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        <p className="mb-3 text-[13px] text-muted-foreground">Physical controls on the glasses — buttons + touch.</p>
