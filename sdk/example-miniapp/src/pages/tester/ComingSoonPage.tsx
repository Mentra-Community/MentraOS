...
const ITEMS: Array<{emoji: string; title: string; subtitle: string}> = [
  ...
  {
    emoji: "🎬",
    title: "Streaming — startUnmanaged/startManaged",
    subtitle: "V2: RTMP/HLS streaming (OS-1302, OS-1303).",
  },
    ...
    <Shell>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        <p className="mb-3 text-[13px] text-muted-foreground">
          These SDK methods are declared but not yet wired end-to-end. They won't fail loudly — they're just no-ops
          today.
        </p>
