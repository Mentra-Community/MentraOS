    ...
    <Shell>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        <p className="mb-4 text-[13px] text-muted-foreground">
          Phone-local storage scoped to this miniapp. Values survive app reloads (but not uninstall). Round-trip test:
          set a key, reload the miniapp (re-scan QR), then get — the value should still be there.
        </p>
        ...
        <div className="mb-4 flex flex-col gap-2 rounded-xl border border-border bg-card p-4">
          ...
          <Label htmlFor="val" className="mt-2">
            Value
          </Label>
