    ...
    <Shell>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        ...
        <Section emoji="📄" title="Text Wall">
          ...
          <Button className="mt-2" onClick={handleTextWall}>
            Show Text Wall
          </Button>
        </Section>
        ...
        <Section emoji="🔼" title="Double Text Wall">
          ...
          <Label htmlFor="bot" className="mt-2">
            Bottom
          </Label>
          <Input id="bot" value={bottomText} onChange={(e) => setBottomText(e.target.value)} />
          <Button className="mt-2" onClick={handleDoubleWall}>
            Show Double Text Wall
          </Button>
        </Section>
        ...
        <Section emoji="🏷️" title="Reference Card">
          ...
          <Button className="mt-2" onClick={handleCard}>
            Show Reference Card
          </Button>
        </Section>
