...
export interface ManifestMutateError {
  code: "unknown_type" | "duplicate" | "invalid_level" | "not_present"
  message: string
...
export function addPermission(m: Manifest, type: string, opts?: {description?: string; required?: boolean}): Manifest {
...
export function addHardware(m: Manifest, type: string, level: string, opts?: {description?: string}): Manifest {
 ...
 */
export function closestAllowedValue<T extends string>(input: string, allowed: readonly T[]): T | null {
