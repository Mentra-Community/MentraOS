...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LSM6DSV16X_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_CUSTOM_A6N_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STDC_LSM6DSV16X, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_30, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_48, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_DEFAULT_MONTSERRAT_14, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_FMT_TXT_LARGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_USE_FONT_COMPRESSED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FS_DEFAULT_DRIVE_LETTER, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_A6N, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_A6N_INIT_PRIORITY, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_A6N_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CUSTOM_DRIVER_MODULE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_FUEL_GAUGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_FUEL_GAUGE_VARIANT_SECONDARY_CELL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_FLUSH_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_FLUSH_THREAD_PRIORITY, -1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_MEM_POOL_SIZE, 65536);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISPLAY_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISPLAY_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSV16X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSV16X_TRIGGER_NONE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_CLOCK_NO_WAIT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_SERIAL_TX_RING_BUFFER_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_SERIAL_LOG_MESSAGE_QUEUE_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_PRINTF_BUFF_SIZE, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x530A);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USER_STEREO_1RX_L_1RX_R, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MENTRAOS_VERSION_STRING, 1);
