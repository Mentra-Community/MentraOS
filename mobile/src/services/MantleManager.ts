...
class MantleManager {
  ...
  private async setupSubscriptions() {
    ...
    // Subscribe to individual Bluetooth SDK events.
    {
      ...
      // wifi_status_change: moved to island DeviceEventRouter (started by toolkit.start())

      // hotspot_status_change: moved to island DeviceEventRouter (started by toolkit.start())
