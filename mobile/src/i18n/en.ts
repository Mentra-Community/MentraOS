const en = {
  ...
  microphoneSettings: {
    ...
    tuningGainSubtitle: "Lower this if the mic clips. Thresholds below are measured after gain.",
    tuningThresholds: "Loudness gate",
    tuningOpen: "Open threshold",
    tuningOpenSubtitle: "Level the gate opens at.",
    tuningClose: "Close threshold",
    tuningCloseSubtitle: "Percent of the open threshold.",
    tuningAttack: "Attack (ms)",
    tuningHangover: "Hangover (ms)",
    tuningHangoverSubtitle: "How long the gate stays open after you stop talking.",
