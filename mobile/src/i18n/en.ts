const en = {
  deviceSettings: {
    ...
    checkForUpdates: "Check for firmware updates",
  ...
  microphoneSettings: {
    ...
    tuningLevel: "Live level",
    tuningLevelSubtitle: "Center-mic RMS after gain. The marker is the open threshold.",
    tuningGateOpen: "Gate open",
    tuningGateClosed: "Gate closed",
    tuningSpeakerElevated: "Speaker playing (elevated thresholds)",
    tuningGainLabel: "Microphone gain",
    tuningGainSubtitle:
    ...
    tuningAttackSubtitle: "How long RMS must stay above open before the gate opens (10 ms frames).",
    tuningHangover: "Hangover (ms)",
    tuningHangoverSubtitle: "How long the gate stays open after RMS drops below close (10 ms frames).",
    tuningSpeakerSection: "During speaker playback",
    ...
    tuningQuery: "Query state",
    tuningQuerySubtitle: "Ask the glasses for the tuning they are actually running (cs_micst).",
    tuningReset: "Reset to firmware defaults",
    tuningResetSubtitle: "Clear RAM overrides so the glasses use firmware defaults.",
    tuningDisconnected: "Connect Mentra Live to tune the microphone.",
  },
  positionSettings: {
  ...
  versionCheck: {
    ...
    upToDateDescription: "The Mentra App is up to date. Returning to the home screen…",
  ...
  pairing: {
    ...
    ar99Step1: "1. Make sure Bluetooth is turned on on your phone.",
    ar99Step2: "2. Press and hold the power button for 3 to 5 seconds to turn on the glasses.",
  },
  ar99Ota: {
    firmwareTitle: "AR99 firmware",
    sourceUnavailable: "AR99 firmware service unavailable",
    sourceDisabled: "Vendor firmware services are unavailable in this deployment.",
    preparingUpdate: "Preparing firmware update",
    checkAgain: "Check firmware again",
    ...
    inspectFirmware: "Check recovery",
    activationUnverified:
      "The glasses validated the transferred image. The running firmware version has not yet been confirmed.",
    resumeExplanation: "Keep your glasses nearby. The existing transfer resumes when they reconnect.",
    ...
    waitingForReconnect: "Waiting for glasses to reconnect",
    ...
    checkFailed: "Couldn't check for firmware updates.",
  ...
  onboarding: {
    ...
    learnAboutOs: "Learn about MentraOS",
  ...
  ota: {
    ...
    updateConnectWifi: "Connect your {{deviceName}} to Wi-Fi to install the update.",
    wifiRequiredTitle: "Wi-Fi Needed for Update",
    ...
    errorDownloadFailed: "Download failed — check glasses Wi-Fi connection",
  ...
  home: {
    ...
    hardwareIncompatibleSingleMessage:
      "This miniapp is incompatible with your {{wearable}} because it requires a {{missing}}.",
  ...
  permissions: {
    ...
    backgroundLocationPermissionRequiredMessage:
      'The Mentra App needs access to your location when the app is in the background to provide location-based features. On the next screen, select Location, then select "Always" instead of "While Using the App".',
    openSettings: "Open Settings",
    permissionRequired: "Permission Required",
  ...
  glasses: {
    ...
    error: "Error",
    photoError: "Couldn’t take a photo",
    download: "Download",
  ...
  settings: {
    ...
    glassesMenuEmpty: "No miniapps in your menu. Tap 'Add Miniapp' below.",
    glassesMenuAddApp: "Add Miniapp",
    glassesMenuAvailableApps: "Available Miniapps",
    glassesMenuNoApps: "No more miniapps available to add.",
    glassesMenuIncompatible: "(incompatible)",
    glassesMenuReset: "Reset to Default",
    glassesMenuApps: "Menu Miniapps",
    ...
    glassesWifiDescription: "Configure Wi-Fi settings for your smart glasses.",
    wifiUnavailable: "Connect a pair of glasses that support Wi-Fi to access Wi-Fi settings.",
    ...
    offlineSTTSubtitle: "Transcribe audio and display the text on connected glasses, entirely offline.",
  ...
  debugSettings: {
    ...
    miniappScanTitle: "Scan Miniapp QR",
    miniappScanHeadline: "Developing a miniapp?",
    miniappScanBody: "Run your miniapp dev server and scan the QR code it prints in the terminal.",
    miniappScanHint: "Point your camera at a miniapp QR code",
    miniappScanPermissionTitle: "Camera access needed",
    miniappScanPermissionBody:
      "We need your camera to scan miniapp QR codes from your dev server. The camera is only used while this screen is open.",
    ...
    miniappUrlLabel: "URL",
    miniappUrlSubtitlePrefix: "Point to a running miniapp dev server. We'll fetch ",
    miniappUrlSubtitleSuffix: " for metadata.",
    miniappUrlLoadButton: "Load Miniapp",
  ...
  errorScreen: {
    ...
    friendlySubtitle:
      "The Mentra App ran into a problem. Try again. If the problem continues, close and reopen the app.",
    reset: "Try again",
