const en = {
  ...
  workspace: {
    ...
    heading: "Connect to your workspace",
    description: "Enter the workspace address provided by your organization.",
    connectAction: "Connect to a workspace",
    urlLabel: "Workspace URL",
    urlPlaceholder: "https://mentra.example.com",
    urlHelper: "Enter the workspace origin without an extra path.",
    unknownResolutionError: "The workspace could not be loaded.",
    confirmTitle: "Confirm workspace",
    candidateExpired: "This workspace confirmation has expired. Enter the workspace URL again.",
    enterAnotherUrl: "Enter workspace URL",
