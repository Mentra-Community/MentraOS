const en = {
  ...
  onboarding: {
    ...
    osCloudMiniappsTitle: "Looking for your Cloud miniapps?",
    osCloudMiniappsMovedTitle: "Cloud miniapps have moved",
    osCloudMiniappsMovedDescription: "Third-party Cloud miniapps aren't available in this version of the Mentra App.",
    osMentraOsLegacyTitle: "Use MentraOS Legacy",
    osMentraOsLegacyDescription: "Visit the MentraOS Legacy page to keep using your Cloud miniapps.",
