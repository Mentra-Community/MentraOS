const en = {
  ...
  miniappDevSettings: {
    ...
    headline: "Build a mini app",
    body: "Mini apps run right on your glasses through the MentraOS SDK. Start your mini app dev server, then scan the QR code it prints — or paste its URL — to load it onto your glasses.",
    readDocs: "Read the docs",
    toolsTitle: "Load a mini app",
    scanLabel: "Scan Mini App QR Code",
    scanSubtitle: "Scan the QR code your dev server prints",
    loadUrlLabel: "Load Mini App from URL",
    loadUrlSubtitle: "Enter a dev server URL to load a mini app",
  },
  transcription: {
