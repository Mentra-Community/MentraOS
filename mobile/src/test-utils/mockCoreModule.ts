...
export const coreModuleMock = {
  ...
  connectByName: jest.fn(() => Promise.resolve()),
  ...
  findCompatibleDevices: jest.fn(() => Promise.resolve()),
  showDashboard: jest.fn(() => Promise.resolve()),
  ping: jest.fn(() => Promise.resolve()),
  requestIncidentLogs: jest.fn(() => Promise.resolve()),
  completeIncidentLogReport: jest.fn(() => Promise.resolve()),
