...
| `session.speaker`             | `play({audioUrl})`, `speak(text, options?)`, `speakSentences(sentences, options?)`, `createStream({sampleRate?, volume?})` for bounded 16-bit PCM output, `stop()`, `onStateChange(handler)`                                                                                                                                                                                                                                                                                                                                   |
