...
SDK for building Mentra miniapps — local JavaScript running in the Mentra App on the phone, with an optional WebView UI and a typed session API for smart glasses.
...
| Module                        | Methods                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `session.display`             | `render(elements, opts?)` — scene API: diffed frames, stable-id in-place updates, `render([])` clears; `list` elements are glasses-native selectable lists                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `session.input`               | `onButtonPress(handler)`, `onTouch(handler \| gesture, handler \| gestures, handler)` — taps on a `list` element carry `selectedItemIndex` / `selectedItemName`                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `session.phone`               | `onBattery(handler)`, `isWifiEnabled()`, `requestWifiEnable(reason?)`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `session.dashboard`           | `setContent(mode, content)` — deferred; warns once and sends a fire-and-forget message that the local runtime ignores without rendering.                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
