...
import {isStarted} from "../runtime/bootstrap"
...
export const firmwareUpdates = {
  ...
  /** Restore optional discovery after sign-in; retained update approvals stay suspended. */
  resumeDiscovery() {
    if (isStarted()) void startLiveAvailability()
  },
