/**
 * `@mentra/island/internal` — the migration-era runtime surface.
 *
 ...
 * OEM-facing `@mentra/island` main entry: new host code should read/act
...
// Bluetooth SDK internal compatibility passthrough. Prefer an island facade
