...
// Mirrors @/config/ota OTA_VERSION_URL_PROD. Inlined here so island owns its OTA
// manifest resolution without reaching back into the host config. Production
// remains the MentraOS compiled fallback because current production glasses
// either advertise that URL or, on older builds, ignore the ota_start manifest
// override and install from their compiled default.
