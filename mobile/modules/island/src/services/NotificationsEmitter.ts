/**
 * Island notifications emitter — the island→host alert channel behind
 * `toolkit.notifications`. Island-detected conditions the host should surface
 ...
 * gap in island's standalone build.
 */
...
export const islandNotifications = {
  ...
  /** Subscribe to island notifications; returns an unsubscribe. */
