/**
 * glasses.settings facade â€?`toolkit.glasses.settings`: the keyed DEVICE-settings
 * surface (brightness, head-up angle, dashboard, camera/button, sensing, â€?. These
...
// user-tunable settings â€?auth, device/controller IDENTITY (set by pairing), and
...
export const glassesSettings = {
  ...
  /** Write a device setting â€?persists and auto-syncs to the connected glasses. */
  ...
  /** The schema descriptor for a key (type, default, optionsâ€?, or undefined. */
