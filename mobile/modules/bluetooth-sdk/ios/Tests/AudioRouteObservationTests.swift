...
final class AudioRouteObservationTests: XCTestCase {
    @MainActor
    func testInputsBecomingAvailableAfterNotificationAreReconciled() async throws {
    ...
    @MainActor
    func testInitiallyReadyInputCanDisappearDuringSettling() async throws {
    ...
    @MainActor
    func testDeviceChangeReplacesPendingChecksAndReadsOnlyCurrentTarget() async throws {
        var target = "first"
    ...
    @MainActor
    func testUnavailableInputStopsRecheckingAfterBoundedWindow() async throws {
        var checks = 0
