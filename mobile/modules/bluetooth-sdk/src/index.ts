...
export const BluetoothSdk: BluetoothSdkPublicModule = Object.freeze({
  ...
  startOtaUpdate,
  wipeMediaForPairing: bindPublicMethod("wipeMediaForPairing"),
  finalizePairingTransfer: bindPublicMethod("finalizePairingTransfer"),
  abortPairingTransfer: bindPublicMethod("abortPairingTransfer"),
  getPairingTransferStatus: bindPublicMethod("getPairingTransferStatus"),
