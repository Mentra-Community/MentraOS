...
export const BluetoothSdk: BluetoothSdkPublicModule = Object.freeze({
  ...
  startExternallyManagedStream: bindPublicMethod("startExternallyManagedStream"),
  stopStream: bindPublicMethod("stopStream"),
  sendExternallyManagedStreamKeepAlive: bindPublicMethod("sendExternallyManagedStreamKeepAlive"),
