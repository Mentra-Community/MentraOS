...
/** K900 `sr_getvol` response (Mentra Live glasses media step volume 0�?5). */
...
export interface WifiSearchResult {
  ...
  signalStrength: number
  /** Frequency in MHz (from glasses scan). 5 GHz band is typically 5170�?825. Omitted if unknown. */
  frequency?: number
}
