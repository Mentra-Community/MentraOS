 ...
 *
 * Builds the system prompt dynamically based on context. Includes device
 * capabilities, response modes, and formatting rules. Ported verbatim from
 * the cloud app — the prompt is platform-agnostic.
 */
